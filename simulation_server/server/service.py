...
def build_scheduler_sim_system_query(*,
    ...
    cols = {
        ...
        "min_loss": latest(sqla.func.coalesce(tbl.c.min_loss, 0)),
        "average_loss": latest(tbl.c.average_loss),
        "max_loss": latest(sqla.func.coalesce(tbl.c.max_loss, 0)),
        ...
        "p_flops": latest(tbl.c.p_flops),
        "g_flops_w": latest(tbl.c.g_flops_w),
    }
